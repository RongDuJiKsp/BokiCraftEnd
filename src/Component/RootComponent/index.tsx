            ...
            <Row>
                <Col span={8} className={"flex items-center overflow-hidden"}>
                    ...
                    <div className={"flex flex-col leading-5 "}>
                        <strong className={"text-3xl font-sans text-blue-400"}>Genshin impact</strong>
                        <small className={"text-red-300 font-mono text-xl"}>袁女士翁，启动</small>
                    </div>
                </Col>
                <Col span={2} className={"text-center"}>
                    <NavLink to={"/uu"} className={(props) => {
                        if (props.isActive) return " text-blue-400 hover:text-green-500";
                        else return "text-red-300 hover:text-yellow-200";
                    }}>
                ...
                <Col span={2} className={"text-center"}>
                    <NavLink to={""} className={(props) => {
                        if (props.isActive) return " text-blue-400 hover:text-green-500";
                        else return "text-red-300 hover:text-green-500";
                    }}>
                        <p className={"text-xl  pt-3 pb-4 m-0"}>主页</p>
                    </NavLink>
                </Col>
                ...
                <Col span={6} className={"text-center text-pink-400 align-bottom pt-1 text-xl"}>
